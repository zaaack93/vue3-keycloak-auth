          ...
          >
            <DropdownHeader tag='div' class='!font-normal'>
              <div class='font-medium'>
                {{ authStore.user.fullName ? authStore.user.fullName : authStore.user.username }}
              </div>
            ...
            >
            <DropdownDivider class='border-white/[0.08]' />
            <DropdownItem class='dropdown-item hover:bg-white/5' @click='authStore.logout'>
...
import {
  ...
  DropdownMenu,
  DropdownToggle,
} from '@/global-components/dropdown'
